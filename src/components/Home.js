...
const Home = () => {
    return(
        ...
        <Link to='/spanish' className="home-cusine">
        ...
        <Link to='/thai' className="home-cusine">
            <div className="cusine">
            <p>Thai</p>
        ...
        <Link to='/moroccan' className="home-cusine">
            <div className="cusine">
            <p>Moroccan</p>
        ...
        <Link to='/british' className="home-cusine">
            <div className="cusine">
            <p>British</p>
        ...
        <Link to='/canadian' className="home-cusine">
            <div className="cusine">
            <p>Canadian</p>
        ...
        <Link to='/french' className="home-cusine">
            <div className="cusine">
            <p>French</p>
        ...
        <Link to='/italian' className="home-cusine">
            <div className="cusine">
            <p>Italian</p>
        ...
        <div className="home-row">
        <Link to='/japonese' className="home-cusine">
            <div className="cusine">
            <p>Japonese</p>
        ...
        <Link to='/mexican' className="home-cusine">
            <div className="cusine">
            <p>Mexican</p>
        ...
        <Link to='/portuguese' className="home-cusine">
            <div className="cusine">
            <p>Portuguese</p>
